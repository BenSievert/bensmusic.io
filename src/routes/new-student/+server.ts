...
export const POST: RequestHandler = async ({ request}) => {
  const { name, teacherExpectations, level, myGoals, practiceIntent, misc, selectedAreasOfInterest, favorites } = await request.json()
  console.log(name, teacherExpectations, level, myGoals, practiceIntent, misc, selectedAreasOfInterest, favorites)
