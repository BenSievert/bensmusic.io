		...
		<Stepper
			steps={[
				...
				subSteps: [
						...
						`The buttons on the top will establish the key in your ear. This means after playing 'Establish C Major' the note C should feel like degree 1.` ,`After playing 'Establish C Major' clicking on the C below should feel like and clicking on G should not.`,
