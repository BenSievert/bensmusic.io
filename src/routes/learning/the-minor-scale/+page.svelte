...
<SitePage title="Learning" subtitle="The Minor Scale" hide>
	<Section theme="secondary" shiftable>
		<Stepper
				steps={[
						{title: `What is the Minor Scale?`, subSteps: [
						...
						{ title: `Chords`,
						 subSteps: [`Our chords in minor are similarly named.`, chordProgressions, `Try playing a i, iv, v in minor`,
						 `Remember that is is just a reordering of our chords from major`, `If you play bIII, bVI, bVII itll sound just like I, IV, V does in major`,`We want to avoid doing that and instead treat "i" like home.`]
						},
						{ title: `Altered Scales`,
						 subSteps: [`When we use the word minor, we're usually referring to Natural Minor. There are two other minor scales worth discussing though.`,
						 `Harmonic `
						 ]
						}
